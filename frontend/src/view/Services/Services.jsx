        ...
        <section className="service__manicure pt-5">
          ...
          <div className="service__manicure--container row justify-content-center mx-0 px-5">
            <article className="service__manicure--container-card col-xl-4 py-3 my-3 border-0">
              ...
              />
              <p className="card__subtitle text-muted mt-3 fw-bold">
                Esmaltado
              </p>
              ...
              <p className="card__text">
                Tenemos para ofrecerte una aplia paleta de colores y
                decoraciones, para que tus Uñas se vean brillantes y perfectas
                de 15 a 20 días. Esmaltado Semi-Permanente es retirado con los
                cuidados y amor que tus Uñas merecen.
              </p>
            ...
            <article className="service__manicure--container-card col-xl-4 py-3 my-3 border-0">
              ...
              <hr className="card__line" />
              <p className="card__text">
                Las uñas esculpidas son una gran solución para dejar de dañar
                tus uñas y qué crezcan sanas y fuertes. Se les dá la forma y
                extensión qué el cliente prefiera. Tus manos se verán perfectas
                y naturales instantáneamente.
              </p>
              <div className="card-footer">
                <small className="text-muted fs-5 fst-italic fw-semibold">
                  Todos los Servicios incluyen Deco
            ...
            <article className="service__manicure--container-card col-xl-4 py-3 my-3 border-0">
              ...
              <hr className="card__line" />
              <p className="card__text">
                Consiste en aplicar una fina capa de gel sobre la uña que
                actuará como una barrera protectora. <br />A diferencia de la
                Esculpidas que "No" alarga la uña natural sino que acompaña el
                crecimiento de la misma y alta duracion.
              </p>
              <div className="card-footer">
                <small className="text-muted fs-5 fst-italic fw-semibold">
                  Todos los Servicios incluyen Deco
          ...
          <div className="service__otros--container row justify-content-center mx-0 px-5">
            ...
            <article className="service__otros--container-card col-xl-4 py-3 my-3 border-0">
              ...
              <p className="card__text">
                ...
                Utilización del bisturí para eliminar durezas y terminaciones
                con torno para darle una forma delicada y perfecta.
              </p>
            </article>
            <article className="service__otros--container-card col-xl-4 py-3 my-3 border-0">
              <img
              ...
              <hr className="card__line" />
              <p className="card__text">
                Consiste en destruir mediante calor las raíces de los vellos
                para que éstos no vuelvan a crecer.
                <br />
                Lo más moderno es método láser, siendo más efectivo, ya que
                permite llegar a temperaturas más altas para tratar los
                folículos pilosos. Dejandondo una piel limpia y delicada.
              </p>
            </article>
          </div>
        </section>
