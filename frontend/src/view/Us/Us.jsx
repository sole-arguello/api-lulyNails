        ...
        <section className="nosotros__somos row py-5">
          <div className="nosotros__somos--container col-xl-7">
            ...
            <p className="nosotros__somos--container-text">
              ...
              últimos años y lo consideramos un accesorio fundamental de la
              moda. Por ese motivo nos especializamos y profesionalizamos para
              ser líderes en el cuidado de manos y pies
            </p>
          </div>
